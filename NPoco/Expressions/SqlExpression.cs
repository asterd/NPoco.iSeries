...
namespace NPoco.Expressions
{
    ...
    {
        public NullableMemberAccess(PocoColumn pocoColumn, string text, Type type)
            : base(pocoColumn, text, type)
        {
        }
    }
    ...
    {
        public EnumMemberAccess(PocoColumn pocoColumn, string text, Type type)
            : base(pocoColumn, text, type)
        {
        }
    }
